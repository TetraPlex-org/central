...
We will have a curated list of skills that is translated to multiple languages but is internally represented as a single token per skill and details of it can be seen here (see [https://github.com/TetraPlex-org/basics/blob/main/Documentation/technical/voting.md#skill-rating]. These skills can be used in job search, freelancing and organizational decision making as outlined in the abvementioned document. Skill points can ber earned via exams, answering questions, participating in debates and other activities.
