...
therefore that the protocol itself is a form of intermediation](http://etheses.dur.ac.uk/13174/1/DisassemblingTrustMachine_JKBrekke_2019.pdf) and hence trust issues do not vanish via the application of math and an intermediary that we still place our trust in still exist even if we adopt these platforms.  At minimum the end users must trust whoever and / or whatever system is in place to keep their private data private and secure.
