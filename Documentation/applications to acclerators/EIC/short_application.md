...
Trust can only be built over time. Our system allows you to interact with others by what we call “personas”, similar to virtual masks, that you can use for different purposes. A persona will eventually include a 3D avatar (including a fully featured 3D home) like in VR Chat. Still, it can be 2D as well so that our main functionality can also be available on low-end mobile devices. However, a persona is not just the visual representation of the user. It includes all sensitive personal details like memberships in organizations and circles of friends, birthdays, location, gender and more. Personas will be much more than filters known from current video chat applications in communication between users. Abstracting the transmission to the persona level will minimize the amount of data needed while ensuring a smooth experience. It will also avoid filter-related problems, potentially exposing details about your personal life. 
Many people, notably the furry community, already use personas online to be less shy and socially awkward. Other communities will benefit from the persona concept as an identity facade rather than a niche concept found in a few online communities and marketing literature. In ancient Latin the word [persona](https://en.wikipedia.org/wiki/Persona) meant "mask." and the word also can refer to a character played by an actor. A persona is not considered a lie or a falsehood, its meaning implies that it is only part of the truth. We do need to be authentic but all of us hide some parts from others. Think of Bruce Wayne and Batman both are partial truths and are authentic. [Carl Jung identified the persona, or the image of one’s self that people like to present to the world, from their shadow, which may include repressed thoughts and hidden anxieties](https://www.structural-learning.com/post/carl-jungs-archetypes). Some think the Batman Persona is more authentic than Bruce Wayne. 
Personas can help with the [right to be forgotten](https://en.wikipedia.org/wiki/Right_to_be_forgotten) you can have several personas and delete some personas as needed as you grow and mature. [Identity formation is part of human development](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4879949/) and we can be a safer space for identity formation than current social media platforms in which you can be too restrained by fears of being ridiculed in the future or be too limited by the need to look good for others and this [fear of being socially ridiculed does negatively influence authenticity online](https://www.pewresearch.org/internet/2014/08/26/social-media-and-the-spiral-of-silence/).
This silence in the major social media platforms is a major flaw in the current incarnation of the [public sphere](https://plato.stanford.edu/entries/habermas/#PublSphe) in discussing and resolving matters of local and global importance leaving a great majority of voices unheard when the internet is supposed to provide a frictionless platform for idea exchange and generation. We will be better than these social media behemoths by removing that fear and enabling causual discussions with veiled chats debates plus enabling the deletion of certain personas at will if required for any reason whatsoever without affecting other personas that the user may have. We can be a platform for [persona studies](https://ojs.deakin.edu.au/index.php/ps) on a grand scale while we give users the ability to craft personas for various circumstances like superheroes which can be both fun and useful. It was useful for Bruce Wayne since his night time crime fighting was high risk and it can be useful for real life heroes like [journalists](https://www.hrw.org/news/2022/10/05/killing-radio-journalist-philippines-adds-grim-toll) who can opt to do a risky expose under a persona. Batman the persona cannot be killed another person can assume the Batman persona if Bruce Wayne died and it maybe the [same for a journalist persona and this had been predicted in works of fiction](https://en.wikipedia.org/wiki/Max_Headroom). You can share the persona with others as well as trade personas or pass it down.  We are proposing a social network in which identity is fluid while having ways to determine whom to trust based on prior interactions on the platform via karma and skill ratings attached to the underlying identity behind the persona. People can use these personas to explore communities in the network that accept them based on their behaviour and character, not being judged or bullied by their appearance and other superficial criteria.  There is research showing that [strong individual or group identities more often divide us](https://www.scientificamerican.com/article/how-identity-not-issues-explains-the-partisan-divide/) that unite us. Making identity fluid in the system may help us step in the shoes of others and help build empathy to those who are different from us. We can have features that encourage exploration of both identity and ideas and the ability to safely explore them in a non toxic environment that encourages positive interaction and exploration.
...
[Facebook and the old traditional social media can be seen as uncool by kids.](https://www.theatlantic.com/ideas/archive/2021/10/facebook-midlife-crisis-boomerbook/620307/). Many now do try out these newer social media sites and apps, and some of these are anonymous.
...
We are high conviction entrepreneurs that want high conviction investors that share our vision of a better virtual and real world mediated and facilitated by social media which is only the latest iteration of information technology of which [Europe once had a lead via the printing press.](https://www.britannica.com/biography/Johannes-Gutenberg) Historically that [old German information tech led to the enlightenment](https://empiresandruins.wordpress.com/2016/10/29/impact-of-the-printing-press-on-enlightenment/). We have to regain that lead again and we need a extensive funding up to TRL 9 so we are opting for blended finance up to the full amount allowed by the EIC of 17.5 million Euro. We are aware that we are giving away 25% the company in exchange for financing but at the moment we have yet to find substantial initial investors in this project and we are in bootstrap mode spending our own time and money building prototypes and refining this idea. We have done internal computations that showed 2.5 million Euro maybe just barely going to cover our labour expenses for 2 years and hence we are opting for the [blended finance model](https://eic.ec.europa.eu/eic-fund-equity-investments-beneficiaries_en). We do need all that to build and market this platform since we got well financed competitors in this space. We have some ideas already for our Go To Market Strategy and a subscription model for revenue. We will be a good and sustainable investment for EU funds and really aim to get unicorn status so that the funds will have outsize returns in both financial and social sense.  We maybe on the cusp of a new enlightenment due to these social media technologies but sadly it had led to fake news, [identity politics and social media bubbles](https://www.nbcnews.com/better/lifestyle/problem-social-media-reinforcement-bubbles-what-you-can-do-about-ncna1063896). We will break up these bubbles by promoting free discussion and exposure to various viewpoints and ideas and hope to promote synthesis of new ideas and maybe even companies or non profits. We can even be the platform that EIC could use itself to promote startups in Europe itself and worldwide and make the EU the next big player in the infotech space.
